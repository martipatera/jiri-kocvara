    ...
    const handlePasswordChange = async(e) =>{
        ...
        try{
            if(password === passwordConfirm){
                const res = await axios.post("https://jiri-kocvara-ow4m.onrender.com/api/forgotpassword",{
                    email: email.trim(),
            ...
            <div className="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#">
                        ...
                        <button onClick={handlePasswordChange} type="submit" className="w-full text-black border-black border hover:brightness-110 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center items-center">{
