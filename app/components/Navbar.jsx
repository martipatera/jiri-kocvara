    ...
    <div >
      <Navbar fluid rounded className={`fixed w-screen z-50 bg-gray-500 rounded-none  ${isScrolled? "bg-opacity-75 " : "bg-opacity-100"}`}>
        ...
        <Navbar.Collapse className="mx-auto">
          ...
          <Link  className={`text-base lg:text-xl text-white font-semibold focus:text-orange  active:text-orange hover:text-orange hover:scale-105 transition-all ${pathname === "/vzdelani" ? "text-orange border-2 rounded-full px-2" : ""}`} href="/vzdelani">Vzdělání</Link>
