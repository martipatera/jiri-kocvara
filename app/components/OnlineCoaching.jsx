        ...
        <Image src={online}
            ...
            On-line coaching 
                ...
                <svg className="flex-shrink-0 w-8 h-8 md:w-3.5 md:h-3.5 text-green-500 mt-5 md:mt-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                    ...
                    <div className="flex items-center flex-col md:flex-row p-4 mb-4 text-sm text-yellow-900 border border-yellow-300 rounded-lg bg-yellow-50" role="alert">
                    <svg className="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                        </svg>
                        <span className="sr-only">Info</span>
                        <div id="text" className="text-center md:text-start">
                            <p className="pt-3 md:pt-0 font-medium text-center md:text-start">POKUD JE JEN TROCHU MOŽNÉ, BUDE SPOLUPRÁCI PŘEDCHÁZET ALESPOŇ PRVNÍ OSOBNÍ SETKÁNÍ, KDE SI PROJDEME DIAGNOSTIKU POHYBOVÉHO APARÁTU a celá spolupráce tak bude ještě efektivnější. Budu tedy rád, když si i přes větší vzdálenost naplánuješ výlet k nám do Berouna. Věřím, že to stojí za to!</p>
                        ...
                        <div className="pt-3 md:pt-0 text-center md:text-start">
                            <span className="font-medium"><strong>Není vhodné pro úplné začátečníky, kteří se chystají do posilovny poprvé nebo mají za sebou jen několik málo prvních tréninků.</strong></span>
                        </div>
                    </div>
                ...
                <span className="flex flex-col xl:flex-row items-center justify-between pt-5 md:px-10 md:pt-10 ">
                    <span className="flex flex-col  justify-center items-center 2xl:items-start">
                        <p className="text-xl font-bold underline whitespace-nowrap decoration-deep-orange-500/50">Cena: Na vyžádání</p>
