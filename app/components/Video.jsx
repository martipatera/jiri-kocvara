...
function VideoComponent() {
  return (
    <div className="mb-2 w-full lg:h-[800px] p-3 md:p-6 m-4 bg-gray-500 border opacity-90 border-gray-200 rounded-xl shadow flex flex-col justify-around items-center">
