...
<div id="background-cointainer-main" className=" min-h-screen w-screen bg-bgMain bg-cover bg-top md:bg-right-bottom mt-12 lg:bg-center md:mt-20 lg:mt-28 xl:mt-20 bg-no-repeat" style={{ aspectRatio: '16/9' }}>
