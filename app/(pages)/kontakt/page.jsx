...
function Kontakt() {
  return (
    <div id='container' className='min-h-screen w-full overflow-x-hidden'>
      <div className='pt-28 sm:pt-32  px-5 lg:px-10'>

          <h1 className='text-4xl md:text-5xl text-center'>Kontakt</h1>
          <hr className="w-2/3 h-1 mx-auto my-4 bg-red-500 border-0 rounded md:my-10 animate-fade dark:bg-gray-700"></hr>
          ...
          <div className=' bg-slate-50 border-2 border-gray-300 rounded-lg shadow flex flex-col lg:flex-row justify-around p-3 mb-3 md:p-5'>
            ...
            <div className='flex flex-col  flex-wrap gap-3 md:gap-4'>
              ...
              <p className='text-2xl md:text-4xl flex-wrap break-words'>Jiří Kočvara</p>

              <span className='flex flex-row justify-start items-center text-lg md:text-xl flex-wrap break-words'>
                <FaSquareFacebook></FaSquareFacebook>
                <a href="https://www.facebook.com/jirka.kocvara.1" target='_blank'>Facebook</a>
              </span>

              <span className='flex flex-row  justify-start items-center text-lg md:text-xl flex-wrap break-words'>
                <FaInstagram></FaInstagram>
                <a href="https://www.instagram.com/jiri_kocvara/" target='_blank'>Instagram</a>
              </span>

              <span className='flex flex-row justify-start items-center text-lg md:text-xl flex-wrap break-words'>
                <MdOutlineEmail></MdOutlineEmail>
                <a href="mailto:trener.jirikocvara@gmail.com" target='_blank' className='break-words overflow-auto'>trener.jirikocvara@gmail.com</a>
              </span>

              <hr className="w-full h-1 mx-auto my-4 bg-red-500 border-0 rounded md:my-10 animate-fade dark:bg-gray-700"></hr>


              <span className='flex flex-col justify-center items-start text-lg md:text-xl flex-wrap break-words'>
                <a href="https://lokomotivaberoun.cz/fitcentrum/" target='_blank' className='break-words  text-xl md:text-2xl'>TJ Lokomotiva Beroun</a>
                <p>266 01 Beroun-Město</p>
                <p>Tyršova 85</p>
              </span>

              <span className='flex flex-col justify-center items-start text-lg md:text-xl flex-wrap break-words'>
                <a href="https://www.tyran.cz/" target='_blank' className='break-words text-xl md:text-2xl'>Fitness Tyran</a>
                <p>266 01 Beroun-Město</p>
                <p>Na Parkáně 366</p>
              </span>
          ...
          <div className=' bg-slate-50 border-2 border-gray-300 rounded-lg items-center shadow flex flex-grow flex-col md:flex-row justify-around gap-5 p-3 mb-3 md:p-3'>
            ...
            <span className='text-center'>
              <h2 className='text-xl lg:text-2xl'>TJ Lokomotiva Beroun</h2> 
            ...
            <span className='text-center'>
              <h2 className='text-xl lg:text-2xl'>Fitness Tyran</h2> 
