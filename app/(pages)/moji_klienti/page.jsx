...
function MojiKlienti() {
  ...
  const sendMessages = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://1934amokge421fsa4219fsklam.vercel.app/api/post_messages",{
        author,
        email,
        subject,
        message,
  ...
  const fetchMessages = async () => {
    try {
      const res = await axios.get("https://1934amokge421fsa4219fsklam.vercel.app/api/get_messages");
...
const deleteMessages = async (id) => {
      ...
      try {
        const res = await axios.delete("https://1934amokge421fsa4219fsklam.vercel.app/api/delete_message",{
          data: {id}
        },{
          cache: "no-store"
        });
    ...
    const fetchUserData = async () => {
      ...
      try {
        const res = await axios.get("https://1934amokge421fsa4219fsklam.vercel.app/api/klienti",{
          cache: "no-store"
        });
        const data = await res.data
